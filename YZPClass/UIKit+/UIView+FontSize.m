...
- (id)myInitWithCoder:(NSCoder*)aDecode {
    ...
    if (self) {
        if (ISCustomFontName){
            self.font  = [UIFont fontWithName:CustomFontName size:self.font.pointSize*[UIView getFontScale]];
        }else{
            self.font = [self.font fontWithSize:self.font.pointSize*[UIView getFontScale]];
        }
    }
    return self;
}
...
- (id)myInitWithCoder:(NSCoder*)aDecode {
    ...
    if (self) {
        ...
        if (ISCustomFontName){
            self.titleLabel.font  = [UIFont fontWithName:CustomFontName size:self.titleLabel.font.pointSize*[UIView getFontScale]];
        }else{
            self.titleLabel.font = [self.titleLabel.font fontWithSize:fontSize*[UIView getFontScale]];
        }
    }
    return self;
}
